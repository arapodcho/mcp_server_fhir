...
async def get_patient_observations(patient_id=None, category=None, observation_id=None, encounter_id=None, code = None, dateFrom = None, dateTo = None, status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if observation_id or encounter_id is missing)
        ...
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if observation_id or patient_id is missing)
        code:  can be None
...
async def get_patient_conditions(patient_id=None, condition_id=None, encounter_id=None, onsetDate = None,  status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if condition_id or encounter_id is missing)        
        condition_id: The FHIR Resource ID of the condition (Optional, if provided, other fields can be omitted)
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if condition_id or patient_id is missing)
...
async def get_patient_medication_requests(patient_id=None, medication_request_id=None, encounter_id=None, status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if medication_request_id or encounter_id is missing)        
        medication_request_id: The FHIR Resource ID of the MedicationRequest (Optional, if provided, other fields can be omitted)
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if medication_request_id or patient_id is missing)
...
async def search_medication_dispenses(patient_id=None, medication_dispense_id=None, encounter_id=None, status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if medication_dispense_id or encounter_id is missing)        
        medication_dispense_id: The FHIR Resource ID of the MedicationDispense (Optional, if provided, other fields can be omitted)
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if medication_dispense_id or patient_id is missing)
...
async def search_medication_administrations(patient_id=None, medication_administration_id=None, encounter_id=None, status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if medication_administration_id or encounter_id is missing)        
        ...
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if medication_administration_id or patient_id is missing)
...
# async def get_patient_encounters(patient_id:Optional[str]=None, input_id:Optional[str]=None, dateFrom :Optional[str]= None, dateTo :Optional[str]= None, status :Optional[str]= None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if encounter_id is missing)
        encounter_id: The FHIR Resource ID of the encounter (Optional, if provided, other fields can be omitted)
        dateFrom: YYYY-MM-DD format (can be None)
        dateTo: YYYY-MM-DD format (can be None)
...
async def get_patient_procedures(patient_id = None, procedure_id=None, encounter_id=None, dateFrom = None, dateTo = None, status = None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if procedure_id or encounter_id is missing)        
        procedure_id: The FHIR Resource ID of the procedure (Optional, if provided, other fields can be omitted)
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if procedure_id or patient_id is missing)
        dateFrom: YYYY-MM-DD format (can be None)
        dateTo: YYYY-MM-DD format (can be None)
...
async def get_patient_immunizations(patient_id=None, immunization_id=None, encounter_id=None):
    ...
    Args:
        patient_id: The FHIR Logical ID of the patient (Optional, but recommended if immunization_id or encounter_id is missing)        
        immunization_id: The FHIR Resource ID of the Immunization (Optional, if provided, other fields can be omitted)
        encounter_id: The FHIR Resource ID of the encounter (Optional, but recommended if immunization_id or patient_id is missing)
    """
    await ensure_auth()
